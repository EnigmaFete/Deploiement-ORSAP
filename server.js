...
const SEED_BLOGS = [
  {
    ...
    summary: "Découvrez les normes de sécurité en vigueur au Maroc pour le montage et l'utilisation d'échafaudages sur vos chantiers et sites industriels.",
...
N'hésitez pas à contacter nos conseillers pour auditer vos besoins en échafaudages professionnels.`,
  ...
  },
  {
    ...
    summary: "L'air comprimé est une ressource énergétique coûteuse. Voici 4 étapes clés pour détecter les fuites et optimiser le rendement de vos compresseurs.",
...
<body>
  <div class="header">
    <div>
      ...
      <div class="nav-tabs">
        <a href="/admin?tab=devis" class="tab-btn ${tab === "devis" ? "active" : ""}">Demandes de devis (${submissions.length})</a>
        <a href="/admin?tab=blog" class="tab-btn ${tab === "blog" ? "active" : ""}">Gestion du Blog (${blogs.length})</a>
      </div>
    </div>
  </div>
